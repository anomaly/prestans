...
class BasicTypeElementTemplateTest(unittest.TestCase):
    ...
    def test_float_default(self):
        ...
        float_btet = BasicTypeElementTemplate(float_type.blueprint())
        self.assertEquals(float_btet.blueprint_type, "float")
        self.assertEquals(float_btet.client_class_name, "Float")
        self.assertEquals(float_btet.required, "true")
        self.assertEquals(float_btet.default, "null")
        self.assertEquals(float_btet.minimum, "null")
        self.assertEquals(float_btet.maximum, "null")
        self.assertEquals(float_btet.choices, "null")
    ...
    def test_float_given_values(self):
        ...
        self.assertEquals(float_btet.blueprint_type, "float")
        self.assertEquals(float_btet.client_class_name, "Float")
        self.assertEquals(float_btet.required, "false")
        self.assertEquals(float_btet.default, 4.56)
        self.assertEquals(float_btet.minimum, 1.0)
        self.assertEquals(float_btet.maximum, 5.0)
        self.assertEquals(float_btet.choices, [1.0, 4.56, 5.0])
