...
class ConfigTest(unittest.TestCase):
    ...
    def test_get_config_for_verb(self):
        ...
        self.assertEqual(config.get_config_for_verb(VERB.HEAD), head_verb_config)
        self.assertEqual(config.get_config_for_verb(VERB.POST), post_verb_config)
        self.assertEqual(config.get_config_for_verb(VERB.PUT), put_verb_config)
        self.assertEqual(config.get_config_for_verb(VERB.PATCH), patch_verb_config)
        self.assertEqual(config.get_config_for_verb(VERB.DELETE), delete_verb_config)
        self.assertEqual(config.get_config_for_verb(VERB.OPTIONS), options_verb_config)
