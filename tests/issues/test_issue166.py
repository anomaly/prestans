...
class Issue166(unittest.TestCase):
    ...
    def test_default_rest_model_lookup(self):
        ...
        self.assertEqual(model_adapter.rest_model_class, AuthorREST)
        self.assertNotEqual(model_adapter.rest_model_class, UserREST)
    ...
    def test_specific_rest_model_lookup(self):
        ...
        self.assertEqual(model_adapter1.rest_model_class, UserREST)
        self.assertNotEqual(model_adapter1.rest_model_class, AuthorREST)

        model_adapter2 = adapters.registry.get_adapter_for_persistent_model(UserPersistent(), AuthorREST)
        self.assertEqual(model_adapter2.rest_model_class, AuthorREST)
        self.assertNotEqual(model_adapter2.rest_model_class, UserREST)
