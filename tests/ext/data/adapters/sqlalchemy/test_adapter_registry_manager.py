...
class AdapterRegistryManagerTest(unittest.TestCase):
    ...
    def test_generate_signature(self):
        ...
        self.assertEqual(rest_a_class_sig, rest_a_instance_sig)
        self.assertEqual(rest_b_class_sig, rest_b_instance_sig)
        self.assertEqual(persistent_class_sig, persistent_instance_sig)

        self.assertNotEqual(rest_a_class_sig, rest_b_class_sig)
        self.assertNotEqual(rest_a_instance_sig, rest_b_instance_sig)
        self.assertNotEqual(rest_a_class_sig, persistent_class_sig)

    def test_init(self):
        registry_manager = adapters.AdapterRegistryManager()
        self.assertEqual(registry_manager._rest_map, {})
        self.assertEqual(registry_manager._persistent_map, {})
    ...
    def test_register_adapter_of_correct_type(self):
        ...
        self.assertEqual(found_adapter.persistent_model_class, PersistentModelA)
